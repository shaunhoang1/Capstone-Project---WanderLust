...
function deleteMovingImage(){
  ...
  for(i in movingObjects){
    ...
    let elmnt = document.getElementById(elID);
    console.log("Deleting  for object with "+elID)
    console.log(elmnt)
    elmnt.remove();
  }
  movingPictures=[];
